  ...
  return (
    <div>
      ...
      <section className="w-1/4 mx-auto">
        <button onClick={handleGoogleSignIn} className="w-4/5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-12 rounded focus:border-none">
          <span className='flex items-center justify-around'><p>Sign in with Google</p> <FaGoogle /></span>
        </button>
      </section>
      <section className="w-1/4 mx-auto">
        <button onClick={handleGithubSignIn} className="w-4/5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-12 my-5 rounded focus:border-none">
